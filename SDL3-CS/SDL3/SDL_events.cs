...
namespace SDL
{
    ...
    public static partial class SDL3
    {
        ...
        public static bool SDL_HasEvent(SDL_EventType type) => SDL_HasEvent((uint)type);
        ...
        public static bool SDL_EventEnabled(SDL_EventType type) => SDL_EventEnabled((uint)type);
